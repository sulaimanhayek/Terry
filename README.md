...
- **Meetings.** A small pill floats over your apps and offers to transcribe when Zoom, Teams, Meet, FaceTime or another app starts using the microphone. While recording, it shows a timer and a stop button. To keep it on screen for one-click recording, turn on Show Floating Pill in the menu bar or Settings. Drag it anywhere and it stays there. When the call ends, the transcript finishes on its own.
...
| Floating pill kept on screen, idle | 0.0% |
